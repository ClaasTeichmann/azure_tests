...
export TARGET_BASE_PATH=/mnt/batch/tasks/fsmounts/shared/palmbase/palm_HB120rsv2

export PATH=/mnt/batch/tasks/fsmounts/shared/palmbase/palm_HB120rsv2/current_version/bin:${PATH}
EOF
